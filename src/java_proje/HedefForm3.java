 ...
 * @author musta
 */
public class HedefForm3 extends javax.swing.JFrame {
    ...
    public HedefForm3(String GelenPuan1, String GelenPuan2,String GelenPuan3){
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDokuz.setBounds(260, 250, 40, 40);
        ...
        lblAlti.setBounds(240, 440, 40, 40);
        ...
        lblYedi.setBounds(450, 140, 40, 40);
        ...
        lblSekiz.setBounds(430, 320, 40, 40);
        ...
        jLabel1.setMinimumSize(new java.awt.Dimension(750, 550));
        jLabel1.setPreferredSize(new java.awt.Dimension(750, 550));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HedefForm3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HedefForm3().setVisible(true);
            }
        });
    }
